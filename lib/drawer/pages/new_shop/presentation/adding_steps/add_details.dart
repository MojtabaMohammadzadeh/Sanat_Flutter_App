          ...
          Container(
              ...
              child:SizedBox.expand(
                child: ElevatedButton(
                    onPressed: () async{
                      var response= await _newShopController.SubmitPlace();
                      if (response == true){
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                SizedBox(height: 16,),
                Text("کاربرگرامی\n فروشگاه شما با موفقیت ثبت شد.\n پس از بررسی توسط کارشناس نتیجه به اطلاع شما خواهد رسید.",

                  style: TextStyle(fontSize: 13, ),textDirection: TextDirection.rtl,
